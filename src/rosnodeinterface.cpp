...
//
// Code generated for Simulink model 'group7undergrad'.
//
// Model version                  : 1.63
// Simulink Coder version         : 24.1 (R2024a) 19-Nov-2023
// C/C++ source code generated on : Mon Nov 18 17:15:21 2024
//
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"group7undergrad\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(group7undergrad_M, (NULL));
        group7undergrad_initialize();
        ...
        mSchedulerTimer = std::make_shared<ros::WallTimer>
          (mNode->createWallTimer(ros::WallDuration(2000000000*1e-9),
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(group7undergrad_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(group7undergrad_M)
                == (NULL)) || rtmGetStopRequested(group7undergrad_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(group7undergrad_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
